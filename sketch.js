...
function setup(){
    ...
    box5 = new Box(525,250,50,50);
    box6 = new Box(575,250,50,50);
    box7 = new Box(625,250,50,50);

    box8 = new Box(550,200,50,50);
    box9 = new Box(600,200,50,50);

    box10 = new Box(575,150,50,50);
...
function draw(){
    ...
    fill("black");
    textSize(20);
    text("Drag the hexagonal stone and release it, to launch towards the blocks.",300,50);
